...
! ---------------------------------------------------------------------------------------
PRINT *, 'Define NetCDF output files - parameter file = ', TRIM(FNAME_NETCDF_PARA)
! Create file
...
IERR = NF_DEF_DIM(ncid_out,'param_set',NPAR,NPAR_DIM); CALL HANDLE_ERR(IERR) ! TODO : max number of parameter - should not be hard-coded
